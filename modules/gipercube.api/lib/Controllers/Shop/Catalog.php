...
class Catalog extends BaseController
{
    ...
    public function listAction(int $iblockId = self::CATLOG_IBLOCK_ID, array $select = [], array $filter = [], int $page = 1, int $size = self::DEFAULT_SIZE_PAGE, PageNavigation $pageNavigation = null): ?array
    {
